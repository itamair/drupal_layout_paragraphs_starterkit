...
namespace Drupal\mycustomtheme;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the MyCustomTheme theme.
 *
 * @internal
 */
class MycustomthemePreRender implements TrustedCallbackInterface {
