...
((Drupal) => {
  const { isDesktopNav } = Drupal.mycustomtheme;
  ...
  Drupal.mycustomtheme.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.mycustomtheme.isDesktopNav()) return;
  ...
  Drupal.mycustomtheme.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.mycustomtheme.areAnySubNavsOpen = areAnySubNavsOpen;
