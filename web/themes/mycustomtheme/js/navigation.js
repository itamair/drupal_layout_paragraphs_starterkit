...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.mycustomtheme.areAnySubNavsOpen()) {
          props.mycustomtheme.closeAllSubNav();
        } else {
      ...
      if (e.key === 'Tab' && isNavOpen(props.navWrapper)) {
        ...
        if (e.shiftKey) {
          if (
            ...
            !props.mycustomtheme.isDesktopNav()
          ) {
    ...
    window.addEventListener('resize', () => {
      if (props.mycustomtheme.isDesktopNav()) {
        toggleNav(props, false);
        props.body.classList.remove('is-overlay-active');
        props.body.classList.remove('is-fixed');
      }
      ...
      Drupal.mycustomtheme.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.mycustomthemeNavigation = {
    attach(context) {
